// main.js – Pratham Final Polished Smart WebApp
import { createClient } from 'https://cdn.skypack.dev/@supabase/supabase-js';

const supabaseUrl = 'https://dgnmnyazzlmcqhbgvjfp.supabase.co';
const supabaseKey = 'YOUR_SUPABASE_KEY_HERE'; // Replace with your real key
...
function renderAdminPanel() {
  ...
  adminDiv.innerHTML = `
    ...
    <form id="product-form" class="space-y-2">
      ...
      <input type="url" id="prod-affiliate" placeholder="Affiliate URL (optional)" class="w-full p-2 border rounded" />
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const affiliate_url = document.getElementById('prod-affiliate').value;
